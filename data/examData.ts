...
const BEER_WINE_KNOWLEDGE_KEY = [
  ...
  { id: 'bw-2', questionText: 'What gluten-free beers & ciders do we offer?', correctAnswer: "Original Sin Black Widow (Cider), Dry Wrought 'Mulled' (Cider), High Noon Pineapple (Seltzer), Long Drink Traditional (Seltzer), Strawberry Orange Mimosa / South Beach Mimosa (Gluten Free Blonde Ale), South beach mimosa", points: 4 },
